<div class="overflow-hidden content-section" id="content-get-characters">
    <h2 id="product-edit">Proposta</h2>
    <pre>
    <code class="bash">
    # Exemplo de Requisição em PHP
    $curl = curl_init();
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'http://localhost:8081/api/product/edit/1',
    ...
    <p>
        ...
        <code class="higlighted">{{ route("api.product.edit") }}</code>
    </p>
    <br>
    <pre>
    <code class="json">
    ...
    <table>
        ...
        <tr>
            <td>id</td>
            <td>integer</td>
            <td>(Obrigatório) Campo ID do produto que deseja editar</td>
        </tr>
        <tr>
            <td>name</td>
            <td>string</td>
